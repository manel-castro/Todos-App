...
export default function About(props) {
  return (
    <React.Fragment>
      ...
      <h1 style={{ paddingTop: "10px", position: "relative", left: "10px" }}>
        About
      </h1>
      <div style={{ padding: "10px", position: "relative", left: "10px" }}>
        <p>
          This project is a continuation of the React Crash Course of Transversy
          Media on Youtube. I added by myself some features.
        </p>
        <br />
        <a
